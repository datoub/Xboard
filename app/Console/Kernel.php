...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command('mail:campaign-watchdog')->everyMinute()->onOneServer()->withoutOverlapping(5);
        $schedule->command('mail:marketing-scan')->everyMinute()->onOneServer()->withoutOverlapping(10);
        // horizon metrics
