...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'email_from_address' => '',
        'remind_mail_enable' => '',
        'email_mass_rate_limit_enable' => 'boolean',
        'email_mass_rate_limit_per_hour' => 'integer|min:1|max:2000',
        'email_mass_dispatch_batch' => 'integer|min:1|max:500',
        'email_mass_retry_limit' => 'integer|min:1|max:10',
        'email_marketing_enable' => 'boolean',
        'email_marketing_rules_json' => 'nullable|string',
        'email_marketing_register_no_order_enable' => 'boolean',
        'email_marketing_register_no_order_minutes' => 'integer|min:1|max:10080',
        'email_marketing_unpaid_order_enable' => 'boolean',
        'email_marketing_unpaid_order_minutes' => 'integer|min:1|max:10080',
        'email_marketing_expire_before_enable' => 'boolean',
        'email_marketing_expire_before_days' => 'integer|min:2|max:365',
        'email_marketing_traffic_exhausted_enable' => 'boolean',
        'email_marketing_expired_after_7d_enable' => 'boolean',
        'email_marketing_expired_after_15d_enable' => 'boolean',
        // telegram
        'telegram_bot_enable' => '',
        'telegram_bot_token' => '',
