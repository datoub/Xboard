  ...
  "settings": {
    ...
    "site": {
      ...
      "form": {
        ...
        "siteUrl": {
          "label": "Site URL (Legacy Fallback)",
          "placeholder": "Please enter site URL, without trailing /",
          "description": "Legacy default URL. After adding the new fields, use Backend URL for node/API access and Frontend URL for user-facing pages."
        },
        "backendUrl": {
          "label": "Backend URL",
          "placeholder": "Example: https://xbo.example.com",
          "description": "Used first for node installation, node communication, payment notify callbacks, and other backend/API URLs. Falls back to Site URL when empty."
        },
        "frontendUrl": {
          "label": "User Frontend URL",
          "placeholder": "Example: https://www.example.com",
          "description": "Used for user theme, landing/publish pages, and fixed payment return URLs. Falls back to Site URL when empty."
        },
        "paymentReturnMode": {
          "label": "Payment Return Mode",
          "placeholder": "Select payment return domain",
          "description": "Source domain returns to the domain used by the user when placing the order. Frontend domain always returns to the configured User Frontend URL.",
          "options": {
            "source": "Return to user's actual access domain",
            "frontend": "Always return to User Frontend URL"
          }
        },
        "forceHttps": {
          "label": "Force HTTPS",
    ...
    "dynamic_form": {
      ...
      "shadowsocks": {
        ...
        "accept_proxy_protocol": {
          ...
          "description": "Enable only when the inbound relay sends a PROXY Protocol v1/v2 header; keep disabled for direct nodes"
        },
